...
def getLLMResponse(query, age_option, tasktype_option):
    ...
    prefix = '''
    You are a {template_ageoption}, and {template_tasktype_option}:
    ...
    example_selector = LengthBasedExampleSelector(example=examples,
                                                  example_prompt=example_prompt,
                                                  max_lenght=200)

    new_prompt_template = FewShotPromptTemplate(example_selector=example_selector,
                                                example_prompt=example_prompt,
                                                prefix=prefix,
                                                suffix=suffix,
                                                input_variables=[
    ...
    response = llm.invoke(
        new_prompt_template.format(template_userInput=query,
